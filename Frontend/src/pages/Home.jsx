      ...
      <footer className="bg-gray-50 pt-20 pb-10 border-t border-gray-100 mt-20">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-8">Khám phá</h4>
              <ul className="flex flex-col gap-4">
                <FooterLink text="Tìm bác sĩ" />
                <FooterLink text="Dịch vụ y tế" />
                <FooterLink text="Chuyên khoa" />
                <FooterLink text="Tin tức sức khỏe" />
              </ul>
            </div>

            {/* Resources */}
            <div>
              <h4 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-8">Thông tin</h4>
              <ul className="flex flex-col gap-4">
            ...
            {/* Contact & Newsletter */}
            <div>
              <h4 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-8">Liên hệ</h4>
              <div className="flex flex-col gap-6">
...
const FooterLink = ({ text }) => (
  <li>
    <a href="#" className="text-sm font-bold text-gray-400 hover:text-blue-600 transition-colors flex items-center gap-2 group">
