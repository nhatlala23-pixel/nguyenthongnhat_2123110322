...
import { Plus, Search, Edit2, Trash2, X, Check, Loader2, Stethoscope, User, Lock, Mail, Activity, Image as ImageIcon, Camera } from 'lucide-react';
...
const AdminDoctors = () => {
  ...
  const handleSubmit = async (e) => {
   ...
   const resetForm = () => {
    setFormData({ username: '', password: '', fullName: '', specialization: '', departmentId: '', image: null });
