    ...
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 h-20">
      <div className="container mx-auto px-6 h-full flex items-center justify-between">
        ...
        <ul className="hidden lg:flex items-center gap-8">
          ...
          <li><a href="#" className="text-sm font-semibold text-gray-500 hover:text-gray-900 transition-colors">Bác sĩ</a></li>
          <li><a href="#" className="text-sm font-semibold text-gray-500 hover:text-gray-900 transition-colors">Tin tức</a></li>
        </ul>

        {/* Actions */}
        <div className="flex items-center gap-6">
          <div className="hidden md:flex relative group">
            <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400 group-focus-within:text-blue-600">
              <Search size={16} />
            </span>
            <input 
              type="text" 
