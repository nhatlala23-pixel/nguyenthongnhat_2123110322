            ...
            doctors.map((doc) => (
              <div key={doc.id} className="group bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-blue-900/10 transition-all duration-500 hover:-translate-y-3">
                ...
                <div className="relative h-80 overflow-hidden bg-gray-100">
                  ...
                  <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-md px-4 py-1.5 rounded-full text-[10px] font-black text-blue-600 uppercase tracking-widest shadow-lg border border-white/50">
                    Chuyên gia uy tín
                  </div>
                ...
                <div className="p-8">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors">{doc.fullName}</h3>
                      <p className="text-gray-400 text-sm font-semibold mt-1">{doc.specialization}</p>
                    </div>
                  ...
                  <button className="w-full bg-blue-600 text-white rounded-2xl py-4 flex items-center justify-center gap-2 font-black text-sm shadow-xl shadow-blue-200 hover:bg-blue-700 transition-all group/btn active:scale-[0.98]">
                    <Calendar size={18} />
