  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 flex flex-col items-center text-center">
        ...
        {/* Title */}
        <h1 className="text-5xl lg:text-7xl font-semibold text-gray-900 leading-tight mb-8 max-w-4xl animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
          Chăm sóc tận tâm,<br />
        ...
        {/* Search Bar */}
        <form onSubmit={handleSearch} className="w-full max-w-3xl bg-white p-2 rounded-[2rem] shadow-2xl shadow-blue-900/10 border border-gray-100 flex flex-col md:flex-row items-center gap-2 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300">
          ...
          <button type="submit" className="w-full md:w-auto bg-blue-600 text-white px-10 py-4 rounded-[1.5rem] font-bold text-sm hover:bg-blue-700 transition-all hover:-translate-x-1 flex items-center justify-center gap-2 group shadow-lg shadow-blue-200">
            Tìm kiếm ngay
